...
## 详细
 * 核心
    > 本项目实现了一个双人在线对战的web21点游戏，进入页面后需要创建房间或者加入房间，等待房间存在两个人准备即可，等待双方准备完毕即可开始游戏，游戏采用轮庄模式，并实时显示服务器在线人数。</br>本项目基于springwebsocket，首先要让所以玩家建立一个链接，即对战平台，建立链接与聊天室的方式一样，才能实时信息交互！只有建立的动态链接才能进行下一步！
